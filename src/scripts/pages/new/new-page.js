    ...
    return `
      <section>
        <div class="new-story__header">
          <div class="container">
            <h1 class="new-story__header__title">Save your story</h1>
            <p class="new-story__header__description">
              Bagikan ceritamu dengan kami.<br>
              Pastikan foto dan detailnya ada untuk mengingatkan kembali kenangan indah anda>
            </p>
          </div>
        </div>
      </section>
